...
$(document).ready(function () {
    ...
    function wow() {
        ...
        const projectBlock = $('.projects-block.thumb');
        projectBlock.odd().addClass('wow animate__backInLeft');
        projectBlock.even().addClass('wow animate__backInRight');

        const stepsItems = $('.steps-item');
        stepsItems.addClass('wow animate__flipInX');

        const pulsePin = $('.excursion-image');
        pulsePin.addClass('wow animate__pulse');
